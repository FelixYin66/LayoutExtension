#
#  Be sure to run `pod spec lint LayoutExtension.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "手动布局扩展控件"

  spec.homepage     = "https://github.com/FelixYin66"
  ...
  spec.author             = { "Felix Yin" => "yinxianjin66@163.com" }
  # Or just: spec.author    = "Felix Yin"
  # spec.authors            = { "Felix Yin" => "yinxianjin66@163.com" }
  ...
  spec.source       = { :git => "https://github.com/FelixYin66/LayoutExtension.git", :tag => spec.version }
  ...
  #spec.source_files  = "ViewLayoutTestDemo/LayoutExtension/**/*.{swift}"
